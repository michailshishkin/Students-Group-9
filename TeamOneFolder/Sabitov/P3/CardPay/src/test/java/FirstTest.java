...
public class FirstTest {
    ...
    public void T7cardnumber() {
        cardNumber.sendKeys("4000000000000777");
        cardHolder.sendKeys("Mr Pony");
        expiresMonth.selectByIndex(11);
        expiresYear.selectByValue("2023");
        cardCvc.sendKeys("125");
    ...
    @Test   // невалидный cardholder
    public void T9Cardholder() {
        cardNumber.sendKeys("4000000000000077");
        cardHolder.sendKeys("222");
        expiresMonth.selectByIndex(8);
        expiresYear.selectByValue("2023");
        cardCvc.sendKeys("125");
        actionSubmit.click();
    ...
    public void T9Year() {
        ...
        String paymentStatus = driver.findElement(By.cssSelector("#card-expires-year > div > label")).getText();
        Assert.assertEquals("Expiration Date is required", paymentStatus);
    }
